...
3. Download the **intro-to-coding-2025 folder** from the TU-COG Github page (https://github.com/TU-Coding-Outreach-Group/intro-to-coding-2025) by pressing the green **Code** button and downloading the ZIP folder. This is the folder containing the all the files that we will be working with for the purposes of this workshop.
...
[Click for solution](https://github.com/TU-Coding-Outreach-Group/intro-to-coding-2025/R/solutions/sol2.R)
